<template>
  <div id="app">
    <h1>Diretivas</h1>
    <p v-text="'Usando diretiva <storng>HTML</strong>'"></p>
    <p v-html="'Usando diretiva <storng>HTML</strong>'"></p>
	...
	<p v-destaque-local:fundo.atrasar.alternar="{cor1: 'green', atraso: 2000}">Usando diretiva personalizada</p>
